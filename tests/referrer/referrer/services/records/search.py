...
class ReferrerSearchOptions(InvenioSearchOptions):
    ...
    facets = {
        ...
        "metadata_internal-array-nested_ref_id": facets.metadata_internal_array_nested_ref_id,
        "metadata_internal-array-nested_ref_test": facets.metadata_internal_array_nested_ref_test,
        "metadata_internal-array-nested_ref_@v": facets.metadata_internal_array_nested_ref__version,
