...
class ReferrerSearchOptions(InvenioSearchOptions):
    ...
    facets = {
        ...
        "metadata_internal-nested_ref_id": facets.metadata_internal_nested_ref_id,
        "metadata_internal-nested_ref_test": facets.metadata_internal_nested_ref_test,
        "metadata_internal-nested_ref_@v": facets.metadata_internal_nested_ref__version,
        "metadata_internal-nested": facets.metadata_internal_nested,
